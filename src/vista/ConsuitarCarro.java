...
public class ConsuitarCarro extends javax.swing.JFrame {
   EquipoSR objEquipoSR=new EquipoSR(); // generación de objeto
    ...
    private void initComponents() {
        ...
        btnActualizar.setText("Verificar");
        btnActualizar.setActionCommand("Lista de prouctos");
        ...
        jtConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre", "Marca", "Modelo", "Año", "Fecha entrega"
            }
        ));
        jScrollPane1.setViewportView(jtConsulta);

        btnPDF.setText("Ver reporte en PDF");
        ...
        jLabel1.setText("Consulta todos los datos");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        try {
            ...
            rs=stmt.executeQuery("SELECT * FROM automovil");
            ...
            modeloDatos.addColumn("anio");
            modeloDatos.addColumn("placa");
            modeloDatos.addColumn("fechaentrega");
    ...
    private void btnPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPDFActionPerformed
        ...
        try {
            String rutaReporte="src/reportes/rptCarro.jasper";
            JasperPrint rptcarrosPDF = JasperFillManager.fillReport(rutaReporte,null,cn);
            JasperViewer ventanaVisor = new JasperViewer(rptcarrosPDF,false);
            ventanaVisor.setTitle("Reporte de automóviles CarWash Biofriendly");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsuitarCarro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsuitarCarro().setVisible(true);
            }
        });
    }
